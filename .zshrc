...
# This line is crucial for fzf to work correctly and for Ctrl+R history search.
...
# Removed 'local' as it's outside a function scope and causes a Zsh syntax error.
...
fch() {
    ...
    selected_command=$(
        ...
        fzf \
            ...
            --ansi # This comment is now correctly on its own line
    )
