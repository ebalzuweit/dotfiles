return {
    ...
    -- The `keys` table tells LazyVim to load this plugin when you press any of these keys.
    -- This is the most important part for making your keymaps work.
    keys = {
        -- Issues
        { "<leader>goiL", "<cmd>Octo issue list<CR>", desc = "Octo: List Issues" },
        { "<leader>gois", "<cmd>Octo issue search<CR>", desc = "Octo: Search Issues" },
        { "<leader>goic", "<cmd>Octo issue create<CR>", desc = "Octo: Create Issue" },
        -- Pull Requests
        { "<leader>gopL", "<cmd>Octo pr list<CR>", desc = "Octo: List PRs" },
        { "<leader>gops", "<cmd>Octo pr search<CR>", desc = "Octo: Search PRs" },
        { "<leader>gopc", "<cmd>Octo pr create<CR>", desc = "Octo: Create PR" },
        -- Notifications
        { "<leader>gonL", "<cmd>Octo notification list<CR>", desc = "Octo: List Notifications" },
        -- Runs
        { "<leader>gorL", "<cmd>Octo run list<CR>", desc = "Octo: List Runs" },
    },
    -- The config function runs after the plugin is loaded.
    config = function()
        -- You can add any custom Octo settings inside this setup call later.
        require("octo").setup({
